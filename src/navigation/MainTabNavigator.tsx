...
> = {
  Home: {focused: 'home', inactive: 'home-outline'},
  Category: {focused: 'grid', inactive: 'grid-outline'},
  Reels: {focused: 'play-circle', inactive: 'play-circle-outline'},
  Cart: {focused: 'cart', inactive: 'cart-outline'},
...
> = {
  ...
  Category: makeTabBarIcon('Category'),
  Reels: makeTabBarIcon('Reels'),
  Cart: makeTabBarIcon('Cart'),
  Profile: makeTabBarIcon('Profile'),
};
